...
var compilers = []grunt.GruntCompiler{
	...
	grunt.GruntCompiler{Name: "kevin_sample JS", Path: "app/assets/js/kevin_sample", Grunt: "uglify:kevin_sample_js"},
	grunt.GruntCompiler{Name: "kevin_sample SASS", Path: "app/assets/sass/kevin_sample", Grunt: "sass:kevin_sample_css"},
}
